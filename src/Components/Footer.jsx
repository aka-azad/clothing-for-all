...
const Footer = () => {
  return (
    <div>
      <footer className="footer footer-center bg-base-300 text-base-content p-4 mt-6">
        <footer className="footer py-5">
          <aside>
            <img className="max-h-12" src={orgLogo} alt="" />
            <h6 className="footer-title">Visit us</h6>
            <ul className="list-disc list-inside text-left text-gray-800 leading-relaxed space-y-2">
        ...
        <aside>
          <p>
            Copyright © {new Date().getFullYear()} - All right reserved by ashraf.azad
          </p>
        </aside>
      </footer>{" "}
    </div>
